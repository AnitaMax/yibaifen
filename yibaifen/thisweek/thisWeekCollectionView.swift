...
class thisWeekCollectionView: UICollectionView ,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    func addtasks(){
       tasks.append(task(day: 1, time: 1, content: "英语", place: "精心楼 f1",color:UIColor.orange))
        ...
        tasks.append(task(day: 2, time: 2, content: "复习高数和英语", place: "逸夫楼 b121",color:UIColor.orange))
       tasks.append(task(day: 6, time: 2, content: "复习高数和英语", place: "逸夫楼 b121",color:UIColor.orange))
        tasks.append(task(day: 5, time: 1, content: "复习英语", place: "逸夫楼 b121",color:UIColor.orange))
         tasks.append(task(day: 5, time: 2, content: "复习高数", place: "精心楼 b121",color:UIColor.orange))
        ...
        tasks.append(task(day: 4, time: 4, content: "复习C++", place: "精心楼 b121",color:UIColor.orange))
         tasks.append(task(day: 6, time: 4, content: "复习C++", place: "精心楼 b121",color:UIColor.orange))
        tasks.append(task(day: 3, time: 2, content: "体育", place: "精心楼 b121",color:UIColor.orange))
         ...
         tasks.append(task(day: 3, time: 5, content: "心理学与生活", place: "精心楼 b121",color:UIColor.orange))
          tasks.append(task(day: 7, time: 2, content: "复习心理学与生活", place: "精心楼 b121",color:UIColor.orange))
       ...
       tasks.append(task(day: 7, time: 4, content: "复习马克思思想", place: "精心楼 b121",color:UIColor.orange))
